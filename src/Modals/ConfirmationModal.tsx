    ...
    const renderContent = () => {
        switch (status) {
            case ExportModalStatus.Confirm:
                return (
                    <p>
                        When your export is done, you&apos;ll get a link to download it as a csv file.
                    </p>
                );
            ...
            case ExportModalStatus.Processing:
                return (
                    <div>
                        <p className="mb-6">{processingMessage}</p>
                ...
                return (
                    <div>
                        ...
                        <button
                            ...
                            disabled={!fileBlob}
                            className="text-[15px] text-[#2b6cb0] hover:underline disabled:opacity-50"
                        >
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Footer */}
                <div className="flex items-center justify-end gap-4 border-t border-gray-100 bg-[#f7f8fb] px-5 py-3">
                    <Button
                        type="button"
                        variant="ghost"
                        onClick={onClose}
                        className="h-[42px] min-w-[70px] rounded-none px-3 text-[16px] font-normal text-[#526dff] hover:bg-transparent hover:text-[#526dff]"
                    >
                        Close
                    </Button>
                    ...
                    {status === ExportModalStatus.Confirm && (
                        <Button
                            ...
                            className="h-[42px] min-w-[112px] rounded-none bg-[#4d70ff] px-[22px] text-[16px] font-normal text-white shadow-none hover:bg-[#4164f5]"
                        >
                            Start export
                        </Button>
                    )}
