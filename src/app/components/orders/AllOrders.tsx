...
const AllOrders = () => {
    ...
    },
    {
      ...
      onClick: async () => {
        try {
          ...
          const resultAction = await dispatch(printPackingSlipPdf({ orderId }));

          if (printPackingSlipPdf.fulfilled.match(resultAction)) {
            const payload = resultAction.payload;
  ...
  return (
    <div className=" bg-[var(--store-bg)] min-h-screen mt-20">
      {/* Tabs */}
      <div className="flex 2xl:space-x-9 space-x-6 border-b mb-4">
                            ...
                            <div className="grid grid-cols-3 gap-4 bg-[#fcfcfb] p-4 ">
                              <div className="flex">
                                ...
                                <div className="flex flex-col border-r pr-3 mr-3 space-y-2">
                                  <h4 className="font-semibold text-[18px] #[34313f]">
                                    Billing
                                  </h4>
                                  <button
