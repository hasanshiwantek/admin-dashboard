            ...
            <TableBody>
              {filteredReturns.map((ret: any) => (
                <React.Fragment key={ret.id}>
                  ...
                  {expandedRow === ret.id && (
                    <TableRow>
                      <TableCell colSpan={9} className="text[var(--background-light)] p-6">
                        <div className="flex justify-between gap-10">
                          {/* Left Column - Return Details */}
                          <div className="flex-1 space-y-4">
                            <h2 className="!text-[24px] font-semibold text-[var(--color-text-secondary)] mb-4">
                              Return Details
                            </h2>
                            ...
                            <div className="flex items-center gap-2 w-3/4">
                              ...
                              <input
                                ...
                                className="flex-1 border border-gray-300 rounded px-3 py-2 text-sm  text-[var(--color-text-muted)] bg-[var(--color-background-subtle)] !h-16"
                                disabled
                              />
                            </div>
                            ...
                            <div className="flex items-center gap-16 w-3/4">
                              <label className="!text-[12px] text-[var(--color-text-secondary)] w-1/4">
                                Customer Comments
                              </label>
                              <textarea
