...
const EditCustomer = () => {
  ...
  const handleBulkDelete = () => {
    ...
    setDeleteAddressIds(selectedIds);
    ...
    <div className="min-h-screen bg-[#f6f7fb]  ">
      <form onSubmit={handleSubmit}>
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          >
            <ArrowLeft size={17} />
            <span className=" text-[#8C93AD] !text-[15px] !font-normal">
              Customers
            </span>
          </button>
          ...
          <div className="bg-white border border-[#e5e7eb] rounded-md p-6 mb-5">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="!text-[22px] font-semibold text-[#313440]">
                Address book
              </h2>
              <button
                type="button"
                            ...
                            <DropdownMenuContent align="end" className="w-32">
                              <DropdownMenuItem
                                ...
                                onClick={() => {
                                  // router.push("/about");
                                  router.push(
                                    `/manage/customers/edit/${id}/${address.id}`,
                                  );
                                }}
                              >
                                Edit
                              ...
                              <DropdownMenuItem
                                ...
                                onClick={() => {
                                  setDeleteAddressIds([address.id]);
                                  setShowDeleteModal(true);
                                }}
                              >
                                Delete
        ...
        <div className="sticky bottom-0 w-full border-t p-4 bg-white flex justify-end gap-3">
          ...
          >
            {loading ? "Saving..." : isEdit ? "Save" : "Add Customer"}
          </button>
        </div>
        <ConfirmationModal
