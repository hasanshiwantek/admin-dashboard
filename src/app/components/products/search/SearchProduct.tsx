...
const SearchProduct = () => {
  ...
  return (
    <div className="p-10">
      ...
      {/* ADVANCED SEARCH */}
      <div className="my-10">
        <h2 className="my-5 !text-3xl !font-bold">Advanced Search</h2>
      ...
      {/* SEARCH BY RANGE */}
      <div className="my-10">
        <h2 className="my-5 !text-3xl !font-bold">Search by Range</h2>
        <div className="bg-white shadow-md p-10 space-y-10">
          <div className="flex items-center gap-4">
      ...
      {/* SEARCH BY SETTING */}
      <div className="my-10">
        <h2 className="my-5 !text-3xl !font-bold">Search by Setting</h2>
        <div className="bg-white shadow-md p-10 space-y-10">
          {[
      ...
      {/* SEARCH BY SORTING */}
      <div className="my-10">
        <h2 className="my-5 !text-3xl !font-bold">Sort Order</h2>
        <div className="bg-white shadow-md p-10 space-y-10">
          <div className="flex items-center gap-4">
