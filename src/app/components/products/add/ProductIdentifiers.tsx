      ...
      <div className="grid grid-cols-2 gap-6 my-4">
        ...
        <div className="space-y-12">
          <div>
            ...
            <Input              className="!max-w-[90%] w-full" value={sku} placeholder="THX-1138" onChange={(e) => setValue("sku", e.target.value)} />
          </div>
          <div>
            <Label className="2xl:!text-2xl" htmlFor="upc">Product UPC/EAN</Label>
            <Input              className="!max-w-[90%] w-full" id="upc" placeholder="" {...register("upc")} />
          </div>
          <div>
            <Label className="2xl:!text-2xl" htmlFor="bpn">Bin Picking Number (BPN)</Label>
            <Input              className="!max-w-[90%] w-full" id="bpn" placeholder="" {...register("bpn")} />
          </div>
        </div>
        ...
        <div className="space-y-12">
          <div>
            ...
            <Input              className="!max-w-[90%] w-full" id="mpn" placeholder="" {...register("mpn")} />
          </div>

          <div>
            <Label className="2xl:!text-2xl" htmlFor="gtin">Global Trade Item Number (GTIN)</Label>
            <Input              className="!max-w-[90%] w-full" id="gtin" {...register("gtin")} />
          </div>
        </div>
      </div>
    </div>
