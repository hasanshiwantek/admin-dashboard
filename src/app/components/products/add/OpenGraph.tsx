...
export default function OpenGraph() {
    ...
    return (
        <div id="openGraphSharing" className="p-10 bg-white shadow-lg rounded-sm ">
            ...
            <div className="my-6">
                <div className="my-6">
                    <Label className="2xl:!text-2xl" htmlFor="objectType">Object Type</Label>
                    <Select
                        value={objectType}
                ...
                <div className="my-6">
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            ...
                            <Label className="2xl:!text-2xl" htmlFor="useThumbnail">Use thumbnail image</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="dontUse" id="dontUse" />
                            <Label className="2xl:!text-2xl" htmlFor="dontUse">Don't use an image</Label>
                        </div>
                    </RadioGroup>
                </div>
            </div>
