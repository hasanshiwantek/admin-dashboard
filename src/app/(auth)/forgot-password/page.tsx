...
//             // You can replace this with a toast or set error state
...
//                 <h1 className="!text-5xl mb-2 !text-white">Enter a new password?</h1>
...
//                         {/* Password */}
//                         <div className="relative w-full sm:w-[34rem] my-4">
//                             <Input
//                                 name="password"
...
//                                 required
//                                 className="w-full !max-w-full !text-2xl px-6 h-20 bg-blue-50 text-black placeholder:text-gray-500 pr-16"
//                             />
//                             <button
//                                 type="button"
...
//                             >
//                                 {formData.showPassword ? <EyeOff size={28} /> : <Eye size={28} />}
//                             </button>
//                         </div>
...
//                                 className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-800"
//                             >
//                                 {formData.showConfirmPassword ? <EyeOff size={28} /> : <Eye size={28} />}
//                             </button>
//                         </div>
