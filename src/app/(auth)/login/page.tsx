...
export default function LoginPage() {
  ...
  <form
    ...
    className="p-10 rounded shadow-md w-full"
  >
  ...
  <p className="mt-5 text-center !text-white max-w-2xl !text-xl sm:!text-2xl">
    Your administrative account information, such as login credentials, is used in accordance with our <a href="#" className="underline text-blue-600">Privacy Policy</a>.
  </p>
</div>
