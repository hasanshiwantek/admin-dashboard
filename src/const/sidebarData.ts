...
export const sidebarData = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Add", url: "/products/add" },
      { title: "Search", url: "/products/search" },
      { title: "Import", url: "/products/import" },
      { title: "Export", url: "/products/export" },
      { title: "Categories", url: "/products/categories" },
      { title: "Options", url: "/products/options" },
      { title: "Filtering", url: "/products/filtering" },
      { title: "Reviews", url: "/products/reviews" },
      { title: "Price Lists", url: "/products/price-lists" },
      { title: "Brands", url: "/products/brands" },
      { title: "Import SKUs", url: "/products/import-skus" },
      { title: "Export SKUs", url: "/products/export-skus" },
    ],
  },
  {
    title: "Customers",
